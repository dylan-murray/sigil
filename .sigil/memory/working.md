---
last_updated: '2026-05-03T15:52:07Z'
manifest_hash: 95e9dfea0cc85892454d7211d69bcf4fcc76ec764c15bc9c8715b7719d66e894
---
...
- #154: Add per-tool call rate limiting to Agent framework (max_calls_per_run, tracking, enforcement)
...
- **Rate limiting feature required one retry**: Initial nudge text mismatch (wrote "rate limit" vs expected) — always align error messages with test expectations before finalizing.
...
- Apr 2026 run: 16 PRs (#139-154) — security tests/fix, type suppressions removed, sandbox/similarity/attempts tests added, per-tool rate limiting
...
6. Add unit tests for the new rate limiting logic in agent.py (edge cases: zero limit, None, multiple tools)
