---
last_updated: '2026-05-02T14:57:14Z'
manifest_hash: 19474638c9e456929899fd8496338e20982c1e0a4d983abe28584a4ab7617a68
---
...
### PRs Opened
- #154: Add per-category disposition routing rules — users can force `pr`, `issue`, or `skip` per finding category in `.sigil/config.yml`
...
## Patterns & Insights
- **Category routing rules are straightforward to implement and validate** – config validation catches errors early; no runtime surprises.
...
4. Add tests for the new category routing rules (edge cases: invalid dispositions, missing category, overlapping rules)
