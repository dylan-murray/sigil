---
last_updated: '2026-05-03T16:02:24Z'
manifest_hash: 20782f01c4cd19c5fc280a55d6b2bbf1c8357c6d5a4402a5308a1d4d655a6667
---
...
- #154: Add stale PR auto-close feature — closes Sigil-opened PRs with no activity after configurable days (default 14). Added `stale_pr_days` to Config, validation, and new `close_stale_prs` function.
...
- **Automating PR lifecycle reduces accumulation**: The stale PR auto-close feature prevents backlog growth without manual intervention.
...
- Apr 2026 run: 16 PRs (#139-154) — security tests/fix, type suppressions removed, sandbox/similarity/attempts tests added, stale PR auto-close
...
6. Verify stale PR auto-close works correctly in next run (test with a mock PR)
