...
- **Temperature gating**: If the model does not support the `temperature` parameter (detected via error message), it is automatically removed from the request and the call is retried
